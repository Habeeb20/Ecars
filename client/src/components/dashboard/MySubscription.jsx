...
// // components/MySubscriptions.jsx
...
//                     {getPlanInfo(activePlan.type).icon}
//                   </div>
...
//                   <div
//                     key={sub._id}
//                     className={`bg-white dark:bg-gray-800 rounded-800 rounded-3xl shadow-xl overflow-hidden transition-all hover:shadow-2xl ${
