...
//       setLoading(true);
//       const url = query 
//         ? `${import.meta.env.VITE_BACKEND_URL}/users/dealers/search?q=${encodeURIComponent(query)}`
//         : `${import.meta.env.VITE_BACKEND_URL}/users/featured-dealers`;
...
//                 </div>
//                 <div className="p-4">
//                   <h3 className="text-xl font-bold mb-1 text-gray-900 dark:text-gray-100">{dealer.dealerInfo?.businessName}</h3>
//                     <p className="text-sm mb-3 text-gray-600 dark:text-gray-400">{dealer.dealerInfo?.phoneNumber}</p>
//                   <p className="text-sm mb-3 text-gray-600 dark:text-gray-400">{dealer.dealerInfo?.state || dealer.state}, {dealer.dealerInfo?.lga || dealer.lga}</p>
...
//                       ))}
//                     </div>
//                     <span className="text-sm text-gray-600 dark:text-gray-400">{dealer.dealerInfo?.rating?.toFixed(1) || dealer.rating?.toFixed(1) || 'N/A'}</span>
//                   </div>
...
//                 {selectedDealer.dealerInfo?.rating ? `${selectedDealer.dealerInfo.rating.toFixed(1)} ★` : selectedDealer.dealerInfo?.businessName}
//               </p>
