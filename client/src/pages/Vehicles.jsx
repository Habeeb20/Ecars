            ...
            {displayVehicles.length > 0 ? (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-3xl p-20 text-center">
                ...
                <button
                  ...
                  className="px-12 py-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-base transition-all transform hover:scale-105" 
                >
                  Clear All Filters
                </button>
              </div>
